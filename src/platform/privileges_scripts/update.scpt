on run {daemon_file, agent_file, user, cur_pid, source_dir}
  ...
  set unload_service to "launchctl unload -w /Library/LaunchDaemons/com.baisoft.RustDesk_service.plist || true;"
  ...
  set sh3 to "launchctl load -w /Library/LaunchDaemons/com.baisoft.RustDesk_service.plist;"
